 ...
 *
 * ARGUMENTS:
 * 1. addr Ptr to area where address is to be placed.
 * 2. addrlen Ptr to int that will hold the final address length.
 * 3. str_addr The input string format hostname, and port.
 * 4. protocol The input string indicating the protocol being used. NULL implies
 * tcp.
 *
 * RETURNS:
 * 0 Success.
